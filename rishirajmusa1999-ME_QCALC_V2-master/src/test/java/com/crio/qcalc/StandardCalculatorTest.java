...
void testMultiplicationOperationForDoubles(){
    standardCalculator.multiply(5.55, 2);
    double actualResult = standardCalculator.getResult();
    Assertions.assertEquals(11.1, actualResult);
}
...
void testDivisionOperationForDoubles(){
    standardCalculator.divide(8.4, 2);
    double actualResult = standardCalculator.getResult();
    Assertions.assertEquals(4.2, actualResult);
}

@Test
@DisplayName("Testing for division by Zero")
